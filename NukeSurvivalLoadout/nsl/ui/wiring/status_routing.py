...
# (:class:`nsl.domain.scanner.Plugin` and the load-result record)
...
def build_info_detail(
    ...
    The returned object is the :class:`nsl.ui.side_panel.PluginDetail`
    dataclass - imported lazily so the wiring module stays import-safe
    without PySide.
    """
    from nsl.ui.side_panel import PluginDetail  # local import - see module docstring.
...
def build_log_detail(
    ...
    *,
    ...
    :class:`nsl.ui.pill.PillState`; we use it only to derive a short
