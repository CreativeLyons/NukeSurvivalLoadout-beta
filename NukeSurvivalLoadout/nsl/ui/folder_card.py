...
class FolderEntry:
    ...
    Attributes:
        ...
        is_global: When True, this is the synthetic Global Plugins row
            ...
            :data:`nsl.constants.GLOBAL_PLUGINS_FOLDER_SENTINEL` so the
...
def _default_confirm_remove_folder(parent: "QtWidgets.QWidget", path: str) -> bool:
    ...
    The card prefers ``nsl.ui.dialogs.confirm_remove_folder``
...
class FolderCard(QtWidgets.QFrame):
    ...
    * ``confirm_remove``: optional callable
      ...
      :func:`nsl.ui.dialogs.confirm_remove_folder` here.
    """
    ...
    def _build(self) -> None:
        ...
        # truth in `nsl/ui/_buttons.py`; edit once, update everywhere.
