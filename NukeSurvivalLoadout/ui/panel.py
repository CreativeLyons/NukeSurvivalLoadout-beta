...
* Qt imports go only via :mod:`NukeSurvivalLoadout.compat` - never
...
# NukeSurvivalLoadout/ui package and carry no nuke dependency.
from NukeSurvivalLoadout.ui._section import SectionBox
from NukeSurvivalLoadout.ui._splitters import HANDLE_QSS, HairlineSplitter, maybe_snap_splitter
from NukeSurvivalLoadout.ui.banner import Banner, BannerKind
from NukeSurvivalLoadout.ui.empty_state import EmptyStateWidget
from NukeSurvivalLoadout.ui.folder_card import FolderCard, FolderEntry, Health
from NukeSurvivalLoadout.ui.grid import (
...
from NukeSurvivalLoadout.ui.grid_toolbar import GridCounterStrip, PluginsGridToolbar
...
from NukeSurvivalLoadout.ui.grid_toolbar import _COUNTER_PURPLE as _GUI_PURPLE
...
from NukeSurvivalLoadout.ui.grid_toolbar import _COUNTER_RED as _REMOVED_RED
from NukeSurvivalLoadout.ui.loadout_strip import Loadout, LoadoutStrip
from NukeSurvivalLoadout.ui.pill import Palette, PillState, PluginPill, Source, StatusIcon, Tint
from NukeSurvivalLoadout.ui.search_tags import SearchTagsStrip
from NukeSurvivalLoadout.ui.side_panel import SidePanel
from NukeSurvivalLoadout.ui.state import (
    folder_list_from,
    loadout_list_from,
    pending_diff,
    pending_diff_split,
...
from NukeSurvivalLoadout.ui.top_toolbar import TopToolbar
    ...
    * :attr:`_left_col_split` - vertical, inside the folder/side pair's
    ...
    def __init__(
        ...
        *,
        ...
        # ``NukeSurvivalLoadout.ui.registry_bootstrap.build_registry_for_panel`` and
        ...
        # :func:`NukeSurvivalLoadout.ui.state.pill_state_from` so
    ...
    def _build_main(self) -> None:
        ...
        * Outer QVBoxLayout (8 px margins, 8 px spacing)
        ...
        from NukeSurvivalLoadout.ui.grid import GROUP_DIVIDER_HEIGHT as _GUTTER_H
        ...
        # ``NukeSurvivalLoadout.ui.wiring.events.should_close_panel`` - the
    ...
    def reset_panel_layout(self) -> None:
        ...
        try:
            from NukeSurvivalLoadout.ui.grid_toolbar import SortMode
    ...
    def _wire_signals(self) -> None:
        ...
        from NukeSurvivalLoadout.ui.wiring.events import wire_events
        from NukeSurvivalLoadout.ui.selection import wire_selection
        from NukeSurvivalLoadout.ui.sort import build_key_to_folder, wire_sort
        from NukeSurvivalLoadout.ui.filter_pipeline import wire_filter_pipeline
        from NukeSurvivalLoadout.ui.wiring.provenance import wire_provenance
        from NukeSurvivalLoadout.ui.wiring.sort_state import wire_sort_state_lookup
        from NukeSurvivalLoadout.ui.wiring.status_routing import wire_status_routing
        from NukeSurvivalLoadout.ui.degraded import wire_degraded
        from NukeSurvivalLoadout.ui.wiring.bulk_ops import wire_bulk_ops
        from NukeSurvivalLoadout.ui.wiring.undo_switch import wire_undo_switch
        from NukeSurvivalLoadout.ui.wiring.reset_global import wire_reset_global
    ...
    def refresh_from_registry(self) -> None:
        ...
        :mod:`NukeSurvivalLoadout.ui.state` and pushes the result into each region's
        ...
        from NukeSurvivalLoadout.constants import DEFAULT_CUSTOM_LOADOUT_STEM as _CUSTOM_STEM
        active_is_custom = (
        ...
        if pipeline is not None:
            ...
            from NukeSurvivalLoadout.ui.wiring.events import rewire_grid_pills
    ...
    def _apply_panic_grid_visual(self, engaged: bool) -> None:
        ...
        :func:`NukeSurvivalLoadout.ui.state.pill_state_from` - a key in
    ...
    def _registry_pill_factory(self, key: str):
        ...
        :func:`NukeSurvivalLoadout.ui.state.pill_state_from` so newly-created pills
        ...
        from NukeSurvivalLoadout.constants import DEFAULT_CUSTOM_LOADOUT_STEM  # noqa: PLC0415
        # loaded-in-session is read off the boot snapshot
        # (``session_loaded_baseline``). A plugin in there was on
        # NUKE_PATH when this Nuke session booted; anything else
...
def _active_strip_name(registry: "Registry") -> str:
    ...
    from NukeSurvivalLoadout.ui.loadout_strip import GLOBAL_LOADOUT_NAME
