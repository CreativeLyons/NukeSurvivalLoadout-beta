...
:mod:`NukeSurvivalLoadout.ui.sort` and
:mod:`NukeSurvivalLoadout.ui.grid_toolbar` concerns.
...
from NukeSurvivalLoadout.ui.sort import build_key_to_folder, build_sort_state_lookup
...
def wire_sort_state_lookup(panel) -> None:
    ...
    1. ``panel.sort_state_lookup`` - the legacy direct path read by
       :func:`NukeSurvivalLoadout.ui.sort.wire_sort._resolve_state_lookup` when no
