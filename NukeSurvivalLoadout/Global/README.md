...
3. Quit Nuke and copy the saved folder into this one:
   `~/.nuke/loadouts/Global_Loadout/`  →  `NukeSurvivalLoadout/Global/Global_Loadout/`
...
- While no `NukeSurvivalLoadout/Global/Global_Loadout/init.py` exists (case A), a user-land
